...
void ADTReader::BeginPlay()
{
	...
	if (MyObjects)
	{
		TArray<FObjects*>Object;
		MyObjects->GetAllRows(ContextString, Object);//Dialogues已获取DataTable所有行信息
		/*for (auto _data : Dialogues) {

		}*/
		FObjects* _data2 = MyObjects->FindRow<FObjects>(_rowname, ContextString, false);//false代表不报错
	}
}
